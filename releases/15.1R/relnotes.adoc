...
The padlock_rng driver is now built on amd64 as well as i386, enabling hardware random number generation on 64-bit Via Nano, Nano X2, and some Zhaoxin CPUs.
...
A new manual page groups(7) has been added describing standard group names.
